...
class AsyncEditClient:
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.edit.create(file=EditCreateRequestFile(), )
        asyncio.run(main())
        """
    ...
    async def create_async(
        ...
        * Processing multiple files in parallel
        ...
        client = AsyncExtend(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.edit.create_async(file=EditCreateAsyncRequestFile(), )
        asyncio.run(main())
        """
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> EditGetResponse:
        ...
        client = AsyncExtend(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.edit.get(id='edit_run_id_here', )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> EditDeleteResponse:
        ...
        client = AsyncExtend(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.edit.delete(id='edit_run_id_here', )
        asyncio.run(main())
        """
