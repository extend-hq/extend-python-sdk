...
from ..types.parse_run_status_enum import ParseRunStatusEnum
...
class ParseRunParams(typing_extensions.TypedDict):
    """
    Parse run object.
    """
    ...
    batch_id: typing_extensions.NotRequired[
        typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="batchId")]
    ]
    """
    ...
    **Availability:** Present when metadata was provided during creation.
    ...
    output: typing.Optional[ParseRunOutputParams]
    """
    ...
    **Availability:** Present when `status` is `"PROCESSED"` and the request was made without the `responseType=url` query parameter. Contains the parsed chunks.
    ...
    output_url: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="outputUrl")]
    """
    ...
    **Availability:** Present when `status` is `"PROCESSED"` and the request was made with `responseType=url` query parameter.
    ...
    metrics: typing.Optional[ParseRunMetricsParams]
    """
