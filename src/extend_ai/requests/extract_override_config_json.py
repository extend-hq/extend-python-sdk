...
from ..types.extraction_base_processor import ExtractionBaseProcessor
...
class ExtractOverrideConfigJsonParams(typing_extensions.TypedDict):
    ...
    base_processor: typing_extensions.NotRequired[
        typing_extensions.Annotated[ExtractionBaseProcessor, FieldMetadata(alias="baseProcessor")]
    ]
