...
from ..types.split_config_base_processor import SplitConfigBaseProcessor
...
class SplitConfigParams(typing_extensions.TypedDict):
    base_processor: typing_extensions.NotRequired[
        typing_extensions.Annotated[SplitConfigBaseProcessor, FieldMetadata(alias="baseProcessor")]
    ]
    """
