...
from ..types.classify_config_base_base_processor import ClassifyConfigBaseBaseProcessor
...
class ClassifyConfigBaseParams(typing_extensions.TypedDict):
    base_processor: typing_extensions.NotRequired[
        typing_extensions.Annotated[ClassifyConfigBaseBaseProcessor, FieldMetadata(alias="baseProcessor")]
    ]
    """
