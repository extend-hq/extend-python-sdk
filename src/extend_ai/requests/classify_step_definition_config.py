...
class ClassifyStepDefinitionConfigParams(typing_extensions.TypedDict):
    """
    ...
    classifier: typing_extensions.NotRequired[ClassifierRefParams]
    """
    ...
    classifier_config: typing_extensions.NotRequired[
        typing_extensions.Annotated[ClassifyConfigParams, FieldMetadata(alias="classifierConfig")]
    ]
    """
