...
class SplitStepDefinitionConfigParams(typing_extensions.TypedDict):
    ...
    splitter: typing_extensions.NotRequired[SplitterRefParams]
    """
    ...
    splitter_config: typing_extensions.NotRequired[
        typing_extensions.Annotated[SplitConfigParams, FieldMetadata(alias="splitterConfig")]
    ]
    """
