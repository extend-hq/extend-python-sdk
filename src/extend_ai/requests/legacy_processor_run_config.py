...
class LegacyProcessorRunConfig_ClassifyParams(typing_extensions.TypedDict):
...
class LegacyProcessorRunConfig_ExtractParams(typing_extensions.TypedDict):
...
class LegacyProcessorRunConfig_SplitterParams(typing_extensions.TypedDict):
...
LegacyProcessorRunConfigParams = typing.Union[
