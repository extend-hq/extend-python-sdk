...
from ..types.legacy_batch_processor_run_source import LegacyBatchProcessorRunSource
from ..types.legacy_batch_processor_run_status import LegacyBatchProcessorRunStatus
...
class LegacyBatchProcessorRunParams(typing_extensions.TypedDict):
    object: str
    """
    ...
    metrics: LegacyBatchProcessorRunMetricsParams
    status: LegacyBatchProcessorRunStatus
    """
    ...
    * `"FAILED"` - The batch processor run encountered an error
    ...
    source: LegacyBatchProcessorRunSource
    """
    ...
    * `"STUDIO"` - The batch processor run was made for a processor in Studio. The `sourceId` will be the ID of the processor (e.g., `"ex_1234"`)
    ...
    source_id: typing_extensions.NotRequired[typing_extensions.Annotated[str, FieldMetadata(alias="sourceId")]]
    """
    ...
    options: LegacyBatchProcessorRunOptionsParams
    """
