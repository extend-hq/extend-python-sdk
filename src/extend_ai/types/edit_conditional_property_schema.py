...
class EditConditionalPropertySchema(UncheckedBaseModel):
    """
    ...
    items: typing.Optional["EditConditionalObjectPropertySchema"] = pydantic.Field(default=None)
    """
    ...
    contains: typing.Optional["EditConditionalPropertySchema"] = pydantic.Field(default=None)
    """
...
update_forward_refs(
    EditConditionalPropertySchema, EditConditionalObjectPropertySchema=EditConditionalObjectPropertySchema
)
