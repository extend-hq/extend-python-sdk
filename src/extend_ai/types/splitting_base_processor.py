...
class SplittingBaseProcessor(enum.StrEnum):
    """
    ...
    _UNKNOWN = "__SPLITTINGBASEPROCESSOR_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "SplittingBaseProcessor":
    ...
    def visit(
        ...
        if self is SplittingBaseProcessor.SPLITTING_PERFORMANCE:
            return splitting_performance()
        if self is SplittingBaseProcessor.SPLITTING_LIGHT:
