...
class SplitterConfig(UncheckedBaseModel):
    ...
    """
    The base processor to use. For splitters, this can currently only be `"splitting_performance"` or `"splitting_light"`. See [Splitting Changelog](https://docs.extend.ai/2025-04-21/changelog/splitting/splitting-performance) for more details.
    """
    ...
    """
    The version of the `"splitting_performance"` or `"splitting_light"` processor to use. If this is provided, the `baseProcessor` must also be provided. See [Splitting Changelog](https://docs.extend.ai/2025-04-21/changelog/splitting/splitting-performance) for more details.
    """
