...
class EditJson(UncheckedBaseModel):
    ...
    * Omitted for enum fields (use enum property instead)
    ...
    extend_edit_field_type: typing_extensions.Annotated[
        typing.Optional[EditJsonExtendEditFieldType], FieldMetadata(alias="extend_edit:field_type")
    ...
    * enum fields (no type) → `radio`, `optionList`, `dropdown`
    ...
    extend_edit_image: typing_extensions.Annotated[
        typing.Optional[EditJsonExtendEditImage], FieldMetadata(alias="extend_edit:image")
    ...
    items: typing.Optional["EditObjectJson"] = pydantic.Field(default=None)
    """
    Schema for array items (when type is "array"). Must be an EditObjectJSON.
    """

    properties: typing.Optional[typing.Dict[str, "EditJson"]] = pydantic.Field(default=None)
    """
...
update_forward_refs(EditJson, EditObjectJson=EditObjectJson)
