...
class RuleValidationResultRulesItem(UncheckedBaseModel):
    ...
    valid_array: typing_extensions.Annotated[typing.Optional[typing.List[bool]], FieldMetadata(alias="validArray")] = (
    ...
    failure_reason: typing_extensions.Annotated[
        typing.Optional[RuleValidationResultRulesItemFailureReason], FieldMetadata(alias="failureReason")
