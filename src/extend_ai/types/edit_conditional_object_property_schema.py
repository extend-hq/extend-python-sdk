...
class EditConditionalObjectPropertySchema(UncheckedBaseModel):
    """
...
update_forward_refs(EditConditionalObjectPropertySchema, EditConditionalPropertySchema=EditConditionalPropertySchema)
