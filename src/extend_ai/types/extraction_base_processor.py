...
class ExtractionBaseProcessor(enum.StrEnum):
    """
    ...
    _UNKNOWN = "__EXTRACTIONBASEPROCESSOR_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "ExtractionBaseProcessor":
    ...
    def visit(
        ...
        if self is ExtractionBaseProcessor.EXTRACTION_PERFORMANCE:
            return extraction_performance()
        if self is ExtractionBaseProcessor.EXTRACTION_LIGHT:
