...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "BatchRunEntityVersion_ClassifierVersionSummary": ".batch_run_entity_version",
    "BatchRunEntityVersion_ExtractorVersionSummary": ".batch_run_entity_version",
    "BatchRunEntityVersion_SplitterVersionSummary": ".batch_run_entity_version",
    "BatchRunEntity_ClassifierSummary": ".batch_run_entity",
    "BatchRunEntity_ExtractorSummary": ".batch_run_entity",
    "BatchRunEntity_SplitterSummary": ".batch_run_entity",
    ...
    "EvaluationSetEntity_ClassifierSummary": ".evaluation_set_entity",
    "EvaluationSetEntity_ExtractorSummary": ".evaluation_set_entity",
    "EvaluationSetEntity_SplitterSummary": ".evaluation_set_entity",
    ...
    "EvaluationSetRunEntityVersion_ClassifierVersionSummary": ".evaluation_set_run_entity_version",
    "EvaluationSetRunEntityVersion_ExtractorVersionSummary": ".evaluation_set_run_entity_version",
    "EvaluationSetRunEntityVersion_SplitterVersionSummary": ".evaluation_set_run_entity_version",
    "EvaluationSetRunEntity_ClassifierSummary": ".evaluation_set_run_entity",
    "EvaluationSetRunEntity_ExtractorSummary": ".evaluation_set_run_entity",
    "EvaluationSetRunEntity_SplitterSummary": ".evaluation_set_run_entity",
