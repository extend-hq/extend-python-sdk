...
class EditJsonSchema(UncheckedBaseModel):
    ...
    * `EditObjectJSONSchema` - type: "object", field_type: "signature"
    ...
    type: typing.Optional[typing.Optional[typing.Any]] = pydantic.Field(default=None)
    """
    ...
    * enum fields (no type) → `radio`, `optionList`, `dropdown`
    ...
    extend_edit_value: typing_extensions.Annotated[
        typing.Optional[typing.Optional[typing.Any]], FieldMetadata(alias="extend_edit:value")
    ] = pydantic.Field(default=None)
    """
...
from .edit_object_json_schema import EditObjectJsonSchema  # noqa: E402, F401, I001

update_forward_refs(EditJsonSchema)
