...
class LegacyProcessor(UncheckedBaseModel):
    ...
    draft_version: typing_extensions.Annotated[LegacyProcessorVersion, FieldMetadata(alias="draftVersion")] = (
        pydantic.Field(alias="draftVersion")
    )
...
update_forward_refs(LegacyProcessor)
