...
class ClassificationBaseProcessor(enum.StrEnum):
    """
    ...
    _UNKNOWN = "__CLASSIFICATIONBASEPROCESSOR_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "ClassificationBaseProcessor":
    ...
    def visit(
        ...
        if self is ClassificationBaseProcessor.CLASSIFICATION_PERFORMANCE:
            return classification_performance()
        if self is ClassificationBaseProcessor.CLASSIFICATION_LIGHT:
