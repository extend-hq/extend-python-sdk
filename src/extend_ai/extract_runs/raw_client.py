...
from .types.extract_runs_cancel_response import ExtractRunsCancelResponse
from .types.extract_runs_create_request_extractor import ExtractRunsCreateRequestExtractor
from .types.extract_runs_create_request_file import ExtractRunsCreateRequestFile
from .types.extract_runs_create_response import ExtractRunsCreateResponse
...
from .types.extract_runs_retrieve_response import ExtractRunsRetrieveResponse
...
class RawExtractRunsClient:
    ...
    def list(
        ...
        *,
        ...
        HttpResponse[ExtractRunsListResponse]
            ...
            To get the full object, use the [Get Extract Run](https://docs.extend.ai/2026-01-01/developers/api-reference/endpoints/extract/get-extract-run) endpoint.
        """
    ...
    def create(
        ...
        *,
        ...
        extractor: typing.Optional[ExtractRunsCreateRequestExtractor] = OMIT,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ExtractRunsCreateResponse]:
        """
        ...
        extractor : typing.Optional[ExtractRunsCreateRequestExtractor]
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "extractor": convert_and_respect_annotation_metadata(
                    object_=extractor, annotation=ExtractRunsCreateRequestExtractor, direction="write"
                ),
                "config": convert_and_respect_annotation_metadata(
                    object_=config, annotation=ExtractConfigJson, direction="write"
                ),
                "file": convert_and_respect_annotation_metadata(
                    object_=file, annotation=ExtractRunsCreateRequestFile, direction="write"
                ),
                "priority": priority,
                "metadata": metadata,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExtractRunsCreateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[ExtractRunsRetrieveResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExtractRunsRetrieveResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[ExtractRunsCancelResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExtractRunsCancelResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawExtractRunsClient:
    ...
    async def create(
        ...
        *,
        ...
        metadata: typing.Optional[RunMetadata] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ExtractRunsCreateResponse]:
        """
        Extract structured data from a file using an existing extractor or an inline configuration.
    ...
    async def retrieve(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ExtractRunsRetrieveResponse]:
        """
        Retrieve details about a specific extract run, including its status, outputs, and any edits made during review.
    ...
    async def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ExtractRunsCancelResponse]:
        """
        Cancel an in-progress extract run.
