...
from ...requests.extract_run_summary import ExtractRunSummaryParams
from ...types.next_page_token import NextPageToken


class ExtractRunsListResponseParams(typing_extensions.TypedDict):
    object: typing.Literal["list"]
    data: typing.Sequence[ExtractRunSummaryParams]
