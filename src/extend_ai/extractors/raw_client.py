...
from .types.extractors_create_response import ExtractorsCreateResponse
from .types.extractors_list_response import ExtractorsListResponse
from .types.extractors_retrieve_response import ExtractorsRetrieveResponse
from .types.extractors_update_response import ExtractorsUpdateResponse
...
class RawExtractorsClient:
    ...
    def create(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ExtractorsCreateResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExtractorsCreateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[ExtractorsRetrieveResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExtractorsRetrieveResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update(
        ...
        *,
        ...
        config: typing.Optional[ExtractConfigJson] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ExtractorsUpdateResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=ExtractorsUpdateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawExtractorsClient:
    ...
    async def create(
        ...
        *,
        ...
        config: typing.Optional[ExtractConfigJson] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ExtractorsCreateResponse]:
        """
        Create a new extractor.
    ...
    async def retrieve(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ExtractorsRetrieveResponse]:
        """
        Get details of an extractor.
    ...
    async def update(
        ...
        *,
        ...
        config: typing.Optional[ExtractConfigJson] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ExtractorsUpdateResponse]:
        """
        Update an existing extractor.
