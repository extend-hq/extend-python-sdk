...
from .types.split_runs_cancel_response import SplitRunsCancelResponse
from .types.split_runs_create_request_file import SplitRunsCreateRequestFile
from .types.split_runs_create_request_splitter import SplitRunsCreateRequestSplitter
from .types.split_runs_create_response import SplitRunsCreateResponse
...
from .types.split_runs_retrieve_response import SplitRunsRetrieveResponse
...
class RawSplitRunsClient:
    ...
    def list(
        ...
        *,
        ...
        HttpResponse[SplitRunsListResponse]
            ...
            To get the full object, use the [Get Split Run](https://docs.extend.ai/2026-01-01/developers/api-reference/endpoints/split/get-split-run) endpoint.
        """
    ...
    def create(
        ...
        *,
        ...
        splitter: typing.Optional[SplitRunsCreateRequestSplitter] = OMIT,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[SplitRunsCreateResponse]:
        """
        ...
        splitter : typing.Optional[SplitRunsCreateRequestSplitter]
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "splitter": convert_and_respect_annotation_metadata(
                    object_=splitter, annotation=SplitRunsCreateRequestSplitter, direction="write"
                ),
                "config": convert_and_respect_annotation_metadata(
                    object_=config, annotation=SplitConfig, direction="write"
                ),
                "file": convert_and_respect_annotation_metadata(
                    object_=file, annotation=SplitRunsCreateRequestFile, direction="write"
                ),
                "priority": priority,
                "metadata": metadata,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=SplitRunsCreateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[SplitRunsRetrieveResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=SplitRunsRetrieveResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[SplitRunsCancelResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=SplitRunsCancelResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawSplitRunsClient:
    ...
    async def create(
        ...
        *,
        ...
        metadata: typing.Optional[RunMetadata] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[SplitRunsCreateResponse]:
        """
        Split a document into multiple parts using an existing splitter or an inline configuration.
    ...
    async def retrieve(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[SplitRunsRetrieveResponse]:
        """
        Retrieve details about a specific split run, including its status and outputs.
    ...
    async def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[SplitRunsCancelResponse]:
        """
        Cancel an in-progress split run.
