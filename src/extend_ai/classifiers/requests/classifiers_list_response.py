...
from ...requests.classifier_summary import ClassifierSummaryParams
from ...types.next_page_token import NextPageToken


class ClassifiersListResponseParams(typing_extensions.TypedDict):
    object: typing.Literal["list"]
    data: typing.Sequence[ClassifierSummaryParams]
