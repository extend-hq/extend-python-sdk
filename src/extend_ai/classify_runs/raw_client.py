...
class RawClassifyRunsClient:
    ...
    def create(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ClassifyRunsCreateResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "classifier": convert_and_respect_annotation_metadata(
                    object_=classifier, annotation=ClassifyRunsCreateRequestClassifier, direction="write"
                ),
                "config": convert_and_respect_annotation_metadata(
                    object_=config, annotation=ClassifyConfig, direction="write"
                ),
                "file": convert_and_respect_annotation_metadata(
                    object_=file, annotation=ClassifyRunsCreateRequestFile, direction="write"
                ),
                "priority": priority,
                "metadata": metadata,
            },
    ...
    ) -> HttpResponse[ClassifyRunsRetrieveResponse]:
        """
    ...
    def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[ClassifyRunsCancelResponse]:
        """
...
class AsyncRawClassifyRunsClient:
    ...
    async def create(
        ...
        *,
        ...
        metadata: typing.Optional[RunMetadata] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ClassifyRunsCreateResponse]:
        """
        Classify a document using an existing classifier or an inline configuration.
    ...
    async def retrieve(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ClassifyRunsRetrieveResponse]:
        """
        Retrieve details about a specific classify run, including its status and outputs.
    ...
    async def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ClassifyRunsCancelResponse]:
        """
        Cancel an in-progress classify run.
