...
class ProcessorRunCreateRequestConfig_ClassifyParams(typing_extensions.TypedDict):
...
class ProcessorRunCreateRequestConfig_ExtractParams(typing_extensions.TypedDict):
...
class ProcessorRunCreateRequestConfig_SplitterParams(typing_extensions.TypedDict):
...
ProcessorRunCreateRequestConfigParams = typing.Union[
