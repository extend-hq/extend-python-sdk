...
from ...requests.evaluation_set import EvaluationSetParams
from ...types.next_page_token import NextPageToken


class EvaluationSetsListResponseParams(typing_extensions.TypedDict):
    object: typing.Literal["list"]
    data: typing.Sequence[EvaluationSetParams]
