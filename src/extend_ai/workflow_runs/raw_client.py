...
from .types.workflow_runs_cancel_response import WorkflowRunsCancelResponse
from .types.workflow_runs_create_batch_request_inputs_item import WorkflowRunsCreateBatchRequestInputsItem
from .types.workflow_runs_create_batch_response import WorkflowRunsCreateBatchResponse
from .types.workflow_runs_create_request_file import WorkflowRunsCreateRequestFile
from .types.workflow_runs_create_request_outputs_item import WorkflowRunsCreateRequestOutputsItem
from .types.workflow_runs_create_response import WorkflowRunsCreateResponse
...
from .types.workflow_runs_retrieve_response import WorkflowRunsRetrieveResponse
from .types.workflow_runs_update_response import WorkflowRunsUpdateResponse
...
class RawWorkflowRunsClient:
    ...
    def list(
        ...
        *,
        ...
        HttpResponse[WorkflowRunsListResponse]
            ...
            To get the full object, use the [Get WorkflowRun](https://docs.extend.ai/2026-01-01/developers/api-reference/endpoints/workflow/get-workflow-run) endpoint.
        """
    ...
    def create(
        ...
        *,
        ...
        outputs: typing.Optional[typing.Sequence[WorkflowRunsCreateRequestOutputsItem]] = OMIT,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[WorkflowRunsCreateResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "workflow": convert_and_respect_annotation_metadata(
                    object_=workflow, annotation=WorkflowReference, direction="write"
                ),
                "file": convert_and_respect_annotation_metadata(
                    object_=file, annotation=WorkflowRunsCreateRequestFile, direction="write"
                ),
                "outputs": convert_and_respect_annotation_metadata(
                    object_=outputs, annotation=typing.Sequence[WorkflowRunsCreateRequestOutputsItem], direction="write"
                ),
                "priority": priority,
                "metadata": metadata,
                "secrets": secrets,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=WorkflowRunsCreateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[WorkflowRunsRetrieveResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=WorkflowRunsRetrieveResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[WorkflowRunsUpdateResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=WorkflowRunsUpdateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[WorkflowRunsCancelResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=WorkflowRunsCancelResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def create_batch(
        ...
        *,
        workflow: WorkflowReference,
        inputs: typing.Sequence[WorkflowRunsCreateBatchRequestInputsItem],
        request_options: typing.Optional[RequestOptions] = None,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "inputs": convert_and_respect_annotation_metadata(
                    object_=inputs,
                    annotation=typing.Sequence[WorkflowRunsCreateBatchRequestInputsItem],
                    direction="write",
                ),
            },
            headers={
...
class AsyncRawWorkflowRunsClient:
    ...
    async def create(
        ...
        *,
        ...
        secrets: typing.Optional[RunSecrets] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[WorkflowRunsCreateResponse]:
        """
        Run a workflow with a file. A workflow is a sequence of steps that process files and data in a specific order to achieve a desired outcome.
    ...
    async def retrieve(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[WorkflowRunsRetrieveResponse]:
        """
        Once a workflow has been run, you can check the status and output of a specific WorkflowRun.
    ...
    async def update(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[WorkflowRunsUpdateResponse]:
        """
        You can update the name and metadata of an in progress WorkflowRun at any time using this endpoint.
    ...
    async def cancel(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[WorkflowRunsCancelResponse]:
        """
        Cancel a running workflow run by its ID. This endpoint allows you to stop a workflow run that is currently in progress.
