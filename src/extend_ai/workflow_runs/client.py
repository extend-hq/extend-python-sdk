...
class WorkflowRunsClient:
    ...
    def cancel(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> WorkflowRunsCancelResponse:
        """
...
class AsyncWorkflowRunsClient:
    ...
    async def create(
        ...
        *,
        ...
        from extend_ai import AsyncExtend, FileFromUrl, WorkflowReference
