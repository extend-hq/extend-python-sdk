...
class ProcessorUpdateRequestConfig_ClassifyParams(typing_extensions.TypedDict):
...
class ProcessorUpdateRequestConfig_ExtractParams(typing_extensions.TypedDict):
...
class ProcessorUpdateRequestConfig_SplitterParams(typing_extensions.TypedDict):
...
ProcessorUpdateRequestConfigParams = typing.Union[
