...
class ProcessorCreateRequestConfig_ClassifyParams(typing_extensions.TypedDict):
...
class ProcessorCreateRequestConfig_ExtractParams(typing_extensions.TypedDict):
...
class ProcessorCreateRequestConfig_SplitterParams(typing_extensions.TypedDict):
...
ProcessorCreateRequestConfigParams = typing.Union[
